function [MOVINGREG] = registerImages110(MOVING,FIXED)
...
fixedPoints = detectMinEigenFeatures(FIXED,'FilterSize',7,'MinQuality',0.425000);
movingPoints = detectMinEigenFeatures(MOVING,'FilterSize',7,'MinQuality',0.425000);
